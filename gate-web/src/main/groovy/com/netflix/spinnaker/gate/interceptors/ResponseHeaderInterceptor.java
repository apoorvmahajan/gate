...
/**
 * Return values (e.g. SPINNAKER-*) stored in the AuthenticatedRequest (backed by MDC and set via
 * com.netflix.spinnaker.filters.AuthenticatedRequestFilter) to gate callers as a response header.
 * For SPINNAKER-REQUEST-ID, if its value is absent from AuthenticatedRequest, value of
 * SPINNAKER-EXECUTION-ID would be returned as the request ID, or a UUID is generated and returned
 * if SPINNAKER-EXECUTION-ID is also absent. For other fields, no values are returned if they are
